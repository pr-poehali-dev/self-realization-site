  ...
  const [forumPosts, setForumPosts] = useState<ForumPost[]>([
    {
      id: 1,
      author: 'Анна К.',
      title: 'Как я нашла свое призвание в 35 лет',
      content: 'Хочу поделиться своей историей кардинальной смены профессии. После 10 лет в банковской сфере я решила стать психологом...',
      category: 'Карьера',
      likes: 24,
      replies: 8,
    ...
    },
    {
      id: 2,
      author: 'Михаил Р.',
      title: 'Медитация как путь к внутренней гармонии',
      content: 'Начал практиковать медитацию 6 месяцев назад. Изменения в жизни просто невероятные! Делюсь техниками...',
      category: 'Духовность',
      likes: 18,
      replies: 12,
    ...
    },
    {
      id: 3,
      author: 'Елена С.',
      title: 'Мой опыт запуска собственного бизнеса',
      content: 'От идеи до первой прибыли прошло 8 месяцев. Расскажу о главных ошибках и победах на этом пути...',
  ...
  const services = [
    {
      ...
      description: 'Персональная работа над вашими целями и планами развития',
      icon: 'User',
      price: 'от 3000₽'
    },
    {
      title: 'Групповые тренинги',
      description: 'Работа в команде единомышленников для достижения результатов',
      icon: 'Users',
      price: 'от 1500₽'
    },
    {
    ...
    {
      title: 'Коучинг сессии',
      description: 'Краткосрочные интенсивные программы личностного роста',
      icon: 'Target',
      price: 'от 4000₽'
    }
  ];
